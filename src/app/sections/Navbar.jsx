      ...
      <div className="flex flex-col lg:hidden gap-6 h-[100%]  ">
        ...
        {toggleMenu && (
          <div className="flex flex-col justify-end bg-primary rounded  w-full gap-2 items-end scale-up-ver-top">
            <Link href="/products" className="text-base small:text-lg  text-white opacity-95  font-normal leading-[116.667%] hover:border-b border-white hover:opacity-100">
              Home
            </Link>
            <Link href="/products" className="text-base small:text-lg  text-white opacity-95  font-normal leading-[116.667%] hover:border-b border-white hover:opacity-100">
              Product
            ...
            <Link
              href="/shoppingCart"
              className="text-base small:text-lg  text-white opacity-95  font-normal leading-[116.667%] hover:border-b border-white hover:opacity-100 flex justify-center items-center">
              Shopping Cart
              <span className="pl-[2px]">
                <AiOutlineShoppingCart width={32} height={28} />
              </span>
