  ...
  return (
    <section className="flex bg-white">
      <div className="flex flex-1 justify-start items-start w-full">
        <Image src={Login} quality={100} placeholder="blur" alt="wine" className="relative object-fill h-screen w-[50vw]" />
      ...
      <div className="flex-1 max-small:py-8 py-6 px-4 md:px-6 lg:px-12 ">
        <h2 className="text-primary font-bold leading-[125%] max-md:text-center small:text-xl sm:text-2xl md:text-3xl mb-8 xs:mb-12 md:mb-16 lg:mb-28">Sign in to PanWines</h2>
        <input
          type="email"
          name="email"
          id="mail"
